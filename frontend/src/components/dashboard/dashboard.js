...
class Dashboard extends React.Component {
  ...
  componentDidMount() {
    if (Cookies.get('token')) {
      ...
      console.warn(this.state.logedIn,'logedin');
    } else {
      // history.push('/');
    }
  }
            ...
            <div className="row">
              <div className="col-12 col-sm-6 col-md-3">
                <div className="info-box">
                  <span className="info-box-icon bg-info elevation-1"><i className="fa fa-gear" /></span>
              ...
              <div className="col-12 col-sm-6 col-md-3">
                <div className="info-box mb-3">
                  <span className="info-box-icon bg-warning elevation-1"><i className="fa fa-users" /></span>
                  <div className="info-box-content">
                    ...
                    <div className="row">
                      <div className="col-sm-3 col-6">
                        <div className="description-block border-right">
                          <span className="description-percentage text-success"><i className="fa fa-caret-up" /> 17%</span>
                      ...
                      <div className="col-sm-3 col-6">
                        <div className="description-block border-right">
                          <span className="description-percentage text-warning"><i className="fa fa-caret-left" /> 0%</span>
                      ...
                      <div className="col-sm-3 col-6">
                        <div className="description-block border-right">
                          <span className="description-percentage text-success"><i className="fa fa-caret-up" /> 20%</span>
                      ...
                      <div className="col-sm-3 col-6">
                        <div className="description-block">
                          <span className="description-percentage text-danger"><i className="fa fa-caret-down" /> 18%</span>
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                ...
                <div className="info-box mb-3 bg-warning">
                  <span className="info-box-icon"><i className="fa fa-tag" /></span>
                  <div className="info-box-content">
                ...
                <div className="info-box mb-3 bg-success">
                  <span className="info-box-icon"><i className="fa fa-heart-o" /></span>
                  <div className="info-box-content">
                ...
                <div className="info-box mb-3 bg-danger">
                  <span className="info-box-icon"><i className="fa fa-cloud-download" /></span>
                  <div className="info-box-content">
                ...
                <div className="info-box mb-3 bg-info">
                  <span className="info-box-icon"><i className="fa fa-comment-o" /></span>
                  <div className="info-box-content">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <ul className="chart-legend clearfix">
                          <li><i className="fa fa-circle-o text-danger" /> Chrome</li>
                          <li><i className="fa fa-circle-o text-success" /> IE</li>
                          <li><i className="fa fa-circle-o text-warning" /> FireFox</li>
                          <li><i className="fa fa-circle-o text-info" /> Safari</li>
                          <li><i className="fa fa-circle-o text-primary" /> Opera</li>
                          <li><i className="fa fa-circle-o text-secondary" /> Navigator</li>
                        </ul>
                      </div>
                      {/* /.col */}
                    </div>
                      ...
                      <li className="nav-item">
                        <a href="#" className="nav-link">
                          ...
                          <span className="float-right text-success">
                            <i className="fa fa-arrow-up text-sm" /> 4%
                          </span>
                        </a>
                      </li>
                      <li className="nav-item">
                        <a href="#" className="nav-link">
                          ...
                          <span className="float-right text-warning">
                            <i className="fa fa-arrow-left text-sm" /> 0%
                          </span>
                        </a>
                      </li>
                    </ul>
